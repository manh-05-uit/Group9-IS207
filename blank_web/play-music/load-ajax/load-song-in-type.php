...
<?php $matl = $_GET['matl'];
$sql = "select * from TheLoai where MaTheLoai = '$matl'";
...
while ($row = $result->fetch_assoc()) { ?>
	<div class="banner"> 
		...
		<div class="banner-content">
			<div>
				<h1>Thể loại <?php echo $row['TenTheLoai']; ?></h1>
...
<?php }
$stmt = $conn->prepare("select * from BaiHat as bh, BaiHat_TheLoai as bh_tl where bh.MaBaiHat = bh_tl.MaBaiHat
and bh_tl.MaTheLoai = ?");
